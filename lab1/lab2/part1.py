...
def run(context):
    ...
    try:
        #variables
        radius1 = 2
        radius2 = 0.156item1 = ui.selectEntity("select a sketch",Sketches)
        ...
        item1 = ui.selectEntity("select a sketch",Sketches)
        point1 = item1.point
        item2 = ui.selectEntity("select a second sketch",Sketches)
        point2 = item2.point
